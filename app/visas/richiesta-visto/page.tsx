  ...
  return (
    <div className="container mx-auto max-w-[900px] py-20">
      ...
      <div className="space-y-5 text-[1.05rem] leading-[1.8] text-[#444]">
        <p>SS EUROPA SOSTEGNO E SOLUZIONI PER L'EUROPA vi assiste nella <strong>richiesta di visti internazionali</strong> per qualsiasi paese del mondo. Che si tratti di un visto turistico, di lavoro, di studio o di ricongiungimento familiare, il nostro team conosce le procedure consolari di numerosi paesi.</p>
