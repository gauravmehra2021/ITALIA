  ...
  return (
    <div className="container mx-auto max-w-[900px] py-20">
      ...
      <div className="space-y-5 text-[1.05rem] leading-[1.8] text-[#444]">
        <p>Proteggere la tua <strong>casa e la tua auto</strong> è fondamentale. SS EUROPA SOSTEGNO E SOLUZIONI PER L'EUROPA ti offre le migliori soluzioni assicurative al prezzo più competitivo, confrontando le offerte delle principali compagnie del mercato.</p>
