  ...
  return (
    <div className="container mx-auto max-w-[900px] py-20">
      ...
      <div className="space-y-5 text-[1.05rem] leading-[1.8] text-[#444]">
        ...
        <p>SS EUROPA SOSTEGNO E SOLUZIONI PER L'EUROPA vi assiste nell'attivazione e nella gestione del servizio SEND, garantendovi di non perdere nessuna comunicazione importante dalla PA.</p>
